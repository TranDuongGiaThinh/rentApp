...
class _ListProductState extends State<ListProduct> {
  List<Product> products = [
    Product(id: 1, pathImage: "asset/img1.png", name: "Orchad House", price: "2.500.000.000", bedrooms: 6, bathroom: 4),
    Product(id: 2, pathImage: "asset/img2.png", name: "The Hollies House", price: "2.000.000", bedrooms: 5, bathroom: 2)
  ];
